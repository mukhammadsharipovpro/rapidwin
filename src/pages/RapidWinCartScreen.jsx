...
import RapidWinCartItemComponent from '../components/RapidWinCartItemComponent';
import RapidWinComponent from '../components/RapidWinComponent';
        ...
        <>
          <View style={{height: height * 0.7}}>
            <ScrollView style={styles.flex} contentContainerStyle={styles.main}>
              {cart.map((item, index) => (
                <RapidWinCartItemComponent item={item} key={index} />
              ))}
            </ScrollView>
          </View>
        </>
